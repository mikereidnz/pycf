            ...
            if self.sl_index:
                ...
                if 'AS' in key:
                    ...
                    for i in range(len(lah)):
                        ...
                        lah[i] = <int> cfl.fnv_hash(&clabels[0], <int>(ll*sizeof(int)//sizeof(char)))
                ...
                if 'DS' in key:
                    ...
                    for i in range(len(ildh)):
                        ...
                        ildh[i] = <int> cfl.fnv_hash(&clabels[0], <int>(ll*sizeof(int)//sizeof(char)))
                        clabels = np.ascontiguousarray(self.fd_states[i, :], dtype=np.int32)
                        fldh[i] = <int> cfl.fnv_hash(&clabels[0], <int>(ll*sizeof(int)//sizeof(char)))
